...
namespace Magestore\SupplierSuccess\Block\Adminhtml\Supplier\Import\Supplier\Import;
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(
            [
                'data' => [
                    'id'      => 'edit_form',
                    'action'  => $this->getUrl('*/*/importSupplierProcess'),
                    'method'  => 'post',
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note'     => 'Only csv file is supported. Click <a target="_blank" href="'
                    . $this->getUrl('suppliersuccess/supplier/downloadSampleSupplier')
